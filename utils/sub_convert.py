            ...
            try:
                ...
                if 'vmess://' in line:
                    try:
                        vmess_json_config = json.loads(
                            base64_decode(line.replace('vmess://', '')))
                ...
                if 'ss://' in line and 'vless://' not in line and 'vmess://' not in line:
                    ...
                    try:
                        ...
                        if '@' in part_list[0]:
                            ...
                            method_part = base64_decode(
                                mix_part[0])
                            server_part = f'{method_part}@{mix_part[1]}'
                        else:
                            server_part = base64_decode(
                                part_list[0])
                ...
                if 'ssr://' in line:
                    try:
                        ...
                        yaml_url.setdefault(
                            'name', base64_decode(param_dic['remarks']))
...
if __name__ == '__main__':
    ...
    content = main(subscribe, 'url', 'YAML')
